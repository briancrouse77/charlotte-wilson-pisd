...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = "https://charlotteforprinceton.com";

  return [
    { url: baseUrl, lastModified: new Date(), changeFrequency: "daily", priority: 1.0 },
    { url: `${baseUrl}/about`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/priorities`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/results-over-rhetoric`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
